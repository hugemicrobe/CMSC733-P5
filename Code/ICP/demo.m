...
[Ricp, Ticp, ER, t] = icp(M, D, 15, 'Matching', 'kDtree', 'Minimize', 'plane', 'Sampling', 'random');
...
[Ricp, Ticp, ER, t] = icp(Mp, Dp, 50, 'EdgeRejection', true, 'Boundary', bound, 'Minimize', 'plane', 'Matching', 'kDtree', 'Sampling', 'random');
...
[Ricp, Ticp, ER, t] = icp(Mp, Dp, 50, 'EdgeRejection', true, 'Boundary', bound, 'Minimize', 'plane', 'Matching', 'kDtree');
